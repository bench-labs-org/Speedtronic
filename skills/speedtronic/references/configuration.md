...
_Every Speedtronic configuration class and field, including defaults, validation, normalization, path semantics, aliases, and precedence._
...
[v2 optimizer](references/optimizers.md), [scheduling](references/scheduling-and-shapes.md), and
[shape validation](references/scheduling-and-shapes.md) pages.
...
For loader and model implementation details, continue to [Data](references/data.md) and [Reference model](references/models-and-extensions.md). For execution, see [Runtime and Trainer](references/architecture.md).
