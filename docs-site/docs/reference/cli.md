...
sidebar_label: CLI
description: Complete reference for speedtronic train, speedtronic validate, and python -m speedtronic.
---
...
`train_from_config()` accepts a config object or dictionary and returns `TrainResult`; see [Runtime and Trainer](./runtime-and-trainer).
